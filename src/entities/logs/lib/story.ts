import type { LogAction, LogEntry } from "@/entities/logs/model/types";
import { i18next } from "@/shared/i18n/i18n";

const STORY_ACTIONS: LogAction[] = ["BATTLE", "REST", "TRAP", "TREASURE"];

const STORY_ACTION_SET = new Set<LogAction>(STORY_ACTIONS);
