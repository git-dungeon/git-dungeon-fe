...
import { resolveStoryMessage } from "@/entities/logs/lib/story";
...
export function resolveActionLabel(action: LogAction): string {
...
export function resolveLogCategoryLabel(category: LogsCategory): string {
...
function pushEnhancementResult(acc: FormattedDeltaEntry[], entry: LogEntry) {
...
function resolveBattleResultLabel(entry: LogEntry): string | undefined {
...
function resolveDeathCauseLabel(entry: LogEntry): string | undefined {
...
function resolveDeathCause(entry: LogEntry): string | undefined {
...
function resolveDeathHandledBy(entry: LogEntry): string | undefined {
