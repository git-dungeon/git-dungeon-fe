...
import type { LogsTimelineProps } from "@/widgets/logs/timeline/ui/timeline";
import { LogsPage } from "./logs-page";

let latestTimelineProps: LogsTimelineProps | null = null;

vi.mock("@/widgets/logs/timeline/ui/timeline", () => ({
  LogsTimeline: (props: LogsTimelineProps) => {
