...
export type LogsFilterSelection = typeof ALL_FILTER_VALUE | LogsFilterType;
...
interface LogsFiltersPanelProps {
  ...
  onDateRangeChange: (next: LogsDateRange) => void;
}

const CATEGORY_FILTERS: LogsFilterType[] = ["EXPLORATION", "STATUS"];
const ACTION_FILTERS: LogsFilterType[] = LOGS_FILTER_TYPES.filter(
