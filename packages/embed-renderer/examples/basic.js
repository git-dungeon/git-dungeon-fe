...
var embed_renderer_1 = require("@git-dungeon/embed-renderer");
var server_1 = require("@git-dungeon/embed-renderer/server");
function example() {
    return __awaiter(this, void 0, void 0, function () {
        var fonts, svg;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, server_1.loadFontsFromFiles)([
                        {
                            name: "Noto Sans KR",
